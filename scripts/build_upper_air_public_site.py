...
def _station_deficit_frame(stations: pd.DataFrame) -> tuple[pd.DataFrame, str]:
    ...
    try:
  …10246 tokens truncated…dden="true"></span><span>Wed</span><span aria-hidden="true"></span><span>Fri</span><span aria-hidden="true"></span><span aria-hidden="true"></span></div><div class="nco-heatmap-grid" style="--nco-week-count:'+weeks+'">'+cells+'</div></div>';
